...
export default async function decorate(block) {
  ...
  if (resp.ok) {
    ...
    signInModal.innerHTML = '<div class="modal-content"><span class="close">&times;</span><div class="container"><label class="sign-in-input" for="email">Email</label><input type="text" placeholder="Enter email" name="email" required><br/><label class="sign-in-input" for="psw"><b>Password</b></label><input type="password" placeholder="Enter Password" name="psw" required><br/><button type="submit">Login</button></div></div>';
